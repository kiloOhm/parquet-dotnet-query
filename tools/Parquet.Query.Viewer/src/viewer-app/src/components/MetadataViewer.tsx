...
export function MetadataViewer({ fileInfo }: MetadataViewerProps) {
  ...
  return (
    <Tabs defaultValue="file" className="h-full">
      ...
      {/* Row Groups */}
      <TabsContent value="rowgroups" className="flex-1 min-h-0">
        <ScrollArea className="h-full">
          <div className="p-4">
            {metadata?.rowGroups ? (
                        ...
                        <table className="w-full text-xs">
                          <thead>
                            <tr className="bg-muted/50">
                              ...
                              <th className="text-center px-2 py-1 font-medium" title="Column Index">CI</th>
                              <th className="text-center px-2 py-1 font-medium" title="Offset Index">OI</th>
                            ...
                            {rg.columns.map((col) => (
                              <tr key={col.columnName} className="border-t">
                                ...
                                <td className="px-2 py-1 text-center">
                                  <BoolCell value={col.hasColumnIndex} />
                                </td>
                                <td className="px-2 py-1 text-center">
                                  <BoolCell value={col.hasOffsetIndex} />
                                </td>
